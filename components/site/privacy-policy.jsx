...
export default function PrivacyPolicy() {
  const pageHeadline = useContent(
    "policies.privacy-policies.headline",
    "Privacy Policy",
  );

  const pageContent = useContent("policies.privacy-policies.content", "");

  const updatedAt = useContent("policies.privacy-policies.updatedAt");

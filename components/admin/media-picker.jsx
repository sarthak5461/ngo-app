  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-3xl h-[90vh] p-0 overflow-hidden flex flex-col">
        ...
        {tab === "library" && (
          <div
            className="p-5 flex-1 min-h-0 flex flex-col overflow-hidden"
            onDragOver={(e) => {
              e.preventDefault();
              setDragActive(true);
            }}
            ...
            <div className="flex items-center justify-between mb-4 gap-3 shrink-0">
              ...
              <div className="flex items-center gap-2">
                <span className="text-xs text-slate-500 hidden sm:inline">
                  {items.length} image(s) • drop to upload
                </span>
              ...
              {loading ? (
                ...
                <div className="h-full flex flex-col items-center justify-center text-slate-400">
                  ...
                  {search
                    ...
                    : "Library is empty. Drop an image here or click Upload."}
                </div>
              ) : (
                    ...
                    {filtered.map((it) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          {sel && (
                            <div className="absolute top-1 right-1 w-6 h-6 rounded-full bg-blue-700 text-white flex items-center justify-center">
            ...
            <div className="space-y-3">
              <div>
                ...
                <p className="text-xs text-slate-500 mt-1.5">
                  Paste any public image URL (Unsplash, Pexels, your CDN…). The
                  image must be reachable from the browser.
                </p>
              </div>
        ...
        {/* ================= FIXED FOOTER ================= */}
        <div className="p-4 border-t bg-slate-50 flex gap-2 justify-end shrink-0">

    ...
    <div className='space-y-5'>
      <div>
        ...
        <p className='text-slate-500 mt-1'>
          Pick a page to edit its sections, text, images and CTAs. Changes save
          to MongoDB and reflect on the live site.
        </p>
      </div>
              ...
              <CardContent className='p-5'>
                ...
                <div className='flex items-center justify-between gap-2'>
                  <Link
                    ...
                    className='text-sm font-semibold text-blue-800 inline-flex items-center group-hover:translate-x-1 transition-transform'
                  >
                  ...
                  {p.href && (
                    <Link
                      href={p.href}
                      target='_blank'
                      className='text-xs text-slate-400 hover:text-blue-800 inline-flex items-center gap-1'
                    >

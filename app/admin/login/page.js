      ...
      <Card className="border-0 shadow-2xl w-full max-w-md overflow-hidden">
        ...
        <CardContent className="p-7">
          ...
          <div className="mt-5 pt-5 border-t text-[11px] text-slate-500 leading-relaxed">
            ...
            cookie-based session with 7-day expiry. Production swap-in:
            JWT verification, OTP-based login, or SSO. RBAC roles already
            defined in <code>lib/auth/rbac.js</code>.
          </div>
        </CardContent>
      </Card>
    </div>

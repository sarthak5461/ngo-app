...
export const PAGES = {
        ...
        fields: [
          {
            ...
            label: "Story Body (full)",
            type: "textarea",
            fallback:
              "The Trust began in 2008, in a borrowed room three lanes from the Jagannath Temple in Puri…",
          },
        ],
      },
      {
        ...
        fields: [
          {
            ...
            type: "textarea",
            fallback:
              "To uplift the most vulnerable sections of Indian society…",
          },
          {
            ...
            type: "textarea",
            fallback:
              "An India where every child is in school, every disaster victim is rescued within hours…",
          },
        ],
      },
    ],
  ...
  ...["education", "disaster-relief", "environment", "healthcare"].reduce(
    (acc, slug) => {
      const titles = {
        education: "Education Program",
        "disaster-relief": "Disaster Relief Program",
        ...
        sections: [
          {
            ...
            fields: [
              ...
              {
                key: `program.${slug}.tagline`,
                label: "Tagline",
                type: "text",
              },
              {
                key: `program.${slug}.image`,
                label: "Hero Image",
                type: "image",
              },
            ],
          },
          {
            ...
            fields: [
              {
                key: `program.${slug}.shortDesc`,
                label: "Short Description",
                type: "textarea",
              },
              {
                key: `program.${slug}.longDesc`,
          ...
          {
            id: "cta",
            label: "Donation CTA Text",
            fields: [
              {
                key: `program.${slug}.ctaLabel`,
                label: "Donate Button Text",
                type: "text",
              },
              {
                key: `program.${slug}.ctaSubtext`,
                label: "CTA Subtext",
                type: "textarea",
              },
            ],
        ...
        fields: [
          {
            ...
            label: "Headline",
            type: "text",
            fallback: "CSR partnerships that deliver real, audited impact.",
          },
        ...
        fields: [
          {
            ...
            label: "Headline",
            type: "text",
            fallback: "Stand with the Trust. Become a member.",
          },
          {
        ...
        fields: [
          {
            ...
            type: "textarea",
            fallback:
              "We call it a support contribution, not a membership fee…",
          },
          {
        ...
        fields: [
          {
            ...
            label: "Address",
            type: "textarea",
            fallback: "Trust Bhavan, Grand Road, Puri, Odisha 752001, India",
          },
          {
            key: "contact.phone",
            label: "Phone",
          ...
          },
          {
            ...
            type: "text",
            fallback: "membership@maakarmadevitrust.org",
          },
          {
            key: "contact.hours",
            label: "Office Hours",
            type: "text",
            fallback: "Mon–Sat, 10 AM – 6 PM IST",
          },
        ],
      },
    ],
